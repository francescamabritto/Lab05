...
public class AnagrammiController {
    ...
    private TextArea txtParola; // Value injected by FXMLLoader
    ...
    void doCalcola(ActionEvent event) {
    		...
    		model.generaAnagrammi(parola);
    		
    		this.txtCorretti.appendText(model.getAnagrammiCorretti().toString());
    		this.txtErrati.appendText(model.getAnagrammiErrati().toString());;
    }
